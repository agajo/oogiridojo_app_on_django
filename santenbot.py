...
def make_santen_picture(odai,answer,answer_picture=""):
  ...
  fnt = ImageFont.truetype('./sawarabi-mincho-medium.ttf',20)
  fnt2 = ImageFont.truetype('./sawarabi-mincho-medium.ttf',15)
  fnt3 = ImageFont.truetype('./sawarabi-mincho-medium.ttf',13)

  #お題描画
  draw.rectangle(((10,10),(640,110)),fill="pink")
  draw.text((12,12),"お題：",font=fnt2,fill="#222222")
  ...
  draw.text((12,122),"回答：",font=fnt2,fill="#222222")
  if(answer_picture != ""):
  ...
  #サイト情報描画
  draw.text((440,image_offset+250),"oka-ryunoske.work/oogiridojo",font=fnt3,fill="#bbbbbb")
